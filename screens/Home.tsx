...
const categories =["Technology","Sports","Politics","Health","Buisness"]

const API_KEY ="pub_20823a015d8d3353c886a3b647b1f487ee004";
const Home = () => {
const [newsData, setNewsData] = useState({})
  ...
  const handleSelect=(val:string)=>{
    setSelectedCategories((prev:string[])=>prev.find((p)=>p===val)
    ?prev.filter((cat)=>cat!==val):[...prev,val]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.filtersContainer}>
        ...
        mode='outlined'
         style={styles.button}
        labelStyle={{fontSize:14,margin:"auto",color:theme.colors.primary}} 
        icon={"sync"} 
        onPress={handlePress}>
          Refresh
        </Button>
